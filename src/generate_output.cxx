...
int main( int argc, const char** argv) {
  ...
  TH1F* corr1DAuAuDPhiLow1 = new TH1F( "corr1DAuAuDPhiLowA", corrected_dphi_subtracted[0][1]->GetTitle(), phiBins1D, phiBoundLow1D, phiBoundHigh1D );
  ...
  TH1F* corr1DAuAuDPhiHigh1 = new TH1F( "corr1DAuAuDPhiHighA", corrected_dphi_subtracted[0][2]->GetTitle(), phiBins1D, phiBoundLow1D, phiBoundHigh1D  );
  ...
  TH1F* corr1DAuAuDEtaLow1 = new TH1F( "corr1DAuAuDEtaLowA", corrected_deta_lead[0][1]->GetTitle(), etaBins1D, etaBoundLow1D, etaBoundHigh1D);
  ...
  TH1F* corr1DAuAuDEtaHigh1 = new TH1F( "corr1DAuAuDEtaHighA", corrected_deta_lead[0][2]->GetTitle(), etaBins1D, etaBoundLow1D, etaBoundHigh1D );
  ...
  TH1F* corr1DPPDPhiLow1 = new TH1F( "corr1DPPDPhiLowA", corrected_dphi_subtracted[1][1]->GetTitle(), phiBins1D, phiBoundLow1D, phiBoundHigh1D  );
  ...
  TH1F* corr1DPPDPhiHigh1 = new TH1F( "corr1DPPDPhiHighA", corrected_dphi_subtracted[1][2]->GetTitle(), phiBins1D, phiBoundLow1D, phiBoundHigh1D  );
  ...
  TH1F* corr1DPPDEtaLow1 = new TH1F( "corr1DPPDEtaLowA", corrected_deta_lead[1][1]->GetTitle(), etaBins1D, etaBoundLow1D, etaBoundHigh1D );
  corr1DPPDEtaLow1->GetXaxis()->SetTitle("#Delta#eta");
  corr1DPPDEtaLow1->GetYaxis()->SetTitle( corrected_deta_lead[0][0]->GetYaxis()->GetTitle() );
  TH1F* corr1DPPDEtaHigh1 = new TH1F( "corr1DPPDEtaHighA", corrected_deta_lead[1][2]->GetTitle(), etaBins1D, etaBoundLow1D, etaBoundHigh1D);
