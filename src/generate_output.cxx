...
int main( int argc, const char** argv) {
  ...
  TH1F* corr1DAuAuDPhiSubLow = new TH1F( "corr1DAuAuDPhiLowRecoil", corrected_dphi_subtracted[0][3]->GetTitle(), phiBins1D, phiBoundLow1D, phiBoundHigh1D );
  ...
  TH1F* corr1DAuAuDPhiSubHigh = new TH1F( "corr1DAuAuDPhiHighRecoil", corrected_dphi_subtracted[0][4]->GetTitle(), phiBins1D, phiBoundLow1D, phiBoundHigh1D  );
  ...
  TH1F* corr1DAuAuDEtaSubLow = new TH1F( "corr1DAuAuDEtaLowRecoil", corrected_deta_lead[0][3]->GetTitle(), etaBins1D, etaBoundLow1D, etaBoundHigh1D);
  ...
  TH1F* corr1DAuAuDEtaSubHigh = new TH1F( "corr1DAuAuDEtaHighRecoil", corrected_deta_lead[0][4]->GetTitle(), etaBins1D, etaBoundLow1D, etaBoundHigh1D );
  ...
  TH1F* corr1DPPDPhiSubLow = new TH1F( "corr1DPPDPhiLowRecoil", corrected_dphi_subtracted[1][3]->GetTitle(), phiBins1D, phiBoundLow1D, phiBoundHigh1D  );
  ...
  TH1F* corr1DPPDPhiSubHigh = new TH1F( "corr1DPPDPhiHighRecoil", corrected_dphi_subtracted[1][4]->GetTitle(), phiBins1D, phiBoundLow1D, phiBoundHigh1D  );
  ...
  TH1F* corr1DPPDEtaSubLow = new TH1F( "corr1DPPDEtaLowRecoil", corrected_deta_lead[1][3]->GetTitle(), etaBins1D, etaBoundLow1D, etaBoundHigh1D );
  ...
  TH1F* corr1DPPDEtaSubHigh = new TH1F( "corr1DPPDEtaHighRecoil", corrected_deta_lead[1][4]->GetTitle(), etaBins1D, etaBoundLow1D, etaBoundHigh1D);
  ...
  TH1F* corr1DAuAuDPhiSubLow1 = new TH1F( "corr1DAuAuDPhiLowRecoilA", corrected_dphi_subtracted[0][1]->GetTitle(), phiBins1D, phiBoundLow1D, phiBoundHigh1D );
  ...
  TH1F* corr1DAuAuDPhiSubHigh1 = new TH1F( "corr1DAuAuDPhiHighRecoilA", corrected_dphi_subtracted[0][2]->GetTitle(), phiBins1D, phiBoundLow1D, phiBoundHigh1D  );
  ...
  TH1F* corr1DAuAuDEtaSubLow1 = new TH1F( "corr1DAuAuDEtaLowRecoilA", corrected_deta_lead[0][1]->GetTitle(), etaBins1D, etaBoundLow1D, etaBoundHigh1D);
  ...
  TH1F* corr1DAuAuDEtaSubHigh1 = new TH1F( "corr1DAuAuDEtaHighRecoilA", corrected_deta_lead[0][2]->GetTitle(), etaBins1D, etaBoundLow1D, etaBoundHigh1D );
  ...
  TH1F* corr1DPPDPhiSubLow1 = new TH1F( "corr1DPPDPhiLowRecoilA", corrected_dphi_subtracted[1][1]->GetTitle(), phiBins1D, phiBoundLow1D, phiBoundHigh1D  );
  ...
  TH1F* corr1DPPDPhiSubHigh1 = new TH1F( "corr1DPPDPhiHighRecoilA", corrected_dphi_subtracted[1][2]->GetTitle(), phiBins1D, phiBoundLow1D, phiBoundHigh1D  );
  ...
  TH1F* corr1DPPDEtaSubLow1 = new TH1F( "corr1DPPDEtaLowRecoilA", corrected_deta_lead[1][1]->GetTitle(), etaBins1D, etaBoundLow1D, etaBoundHigh1D );
  ...
  TH1F* corr1DPPDEtaSubHigh1 = new TH1F( "corr1DPPDEtaHighRecoilA", corrected_deta_lead[1][2]->GetTitle(), etaBins1D, etaBoundLow1D, etaBoundHigh1D);
