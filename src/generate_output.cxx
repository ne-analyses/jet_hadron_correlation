...
int main( int argc, const char** argv) {
  ...
  for (int i = 0; i < nFiles; ++i ) {
    for ( int j = 0; j < nPtBins; ++ j ) {
      ...
      td::string corrNameProj2 = "tmp/corrtestproj_"; corrNameProj2 += patch::to_string(i); corrNameProj2 += patch::to_string(j); corrNameProj2 += ".pdf";
      ...
      reducedHist[i][j]->ProjectionX()->Draw();
      c1.SaveAs( corrNameProj2.c_str() );
