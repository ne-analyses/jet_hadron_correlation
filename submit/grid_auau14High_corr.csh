...
#  [9]: bins in Eta for correlation histograms
#  [10]: bins in phi for correlation histograms
#
...
set base = /nfs/rhi/STAR/Data/HaddedAuAu14High/AuAu14Pico
...
if ( ! -d out/y14high/${analysis}/${outFile} ) then
mkdir -p out/y14high/${analysis}/${outFile}
mkdir -p out/y14high/${analysis}/${outFile}/correlations
mkdir -p out/y14high/${analysis}/${outFile}/tree
mkdir -p out/y14high/${analysis}/${outFile}/mixing
endif

if ( ! -d log/y14high/${analysis}/${outFile} ) then
mkdir -p log/y14high/${analysis}/${outFile}
endif
...
set outLocation = "out/y14high/${analysis}/${outFile}/"
...
set LogFile     = log/y14high/${analysis}/${outFile}/${analysis}_${OutBase}.log
set ErrFile     = log/y14high/${analysis}/${outFile}/${analysis}_${OutBase}.err
...
qsub -V -q erhiq -l mem=6GB -o $LogFile -e $ErrFile -N auauCorr -- ${ExecPath}/submit/qwrap.sh ${ExecPath} $execute $arg
