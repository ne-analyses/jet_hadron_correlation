...
if ( ! -d log/pp_bkg/mix/${logBase} ) then
mkdir -p log/pp_bkg/mix/${logBase}
endif
...
set LogFile     = log/pp_bkg/mix/${logBase}/mix_${OutBase}.log
set ErrFile     = log/pp_bkg/mix/${logBase}/mix_${OutBase}.err
...
qsub -q erhiq -V -l mem=10GB -o $LogFile -e $ErrFile -N auauMix -- ${ExecPath}/submit/qwrap.sh ${ExecPath} $execute $arg
